# Temporarily re-added after upstream removal (oe-core 188d84bcc136,
# "gptfdisk: remove recipe"): meta-tegra's image_types_tegra.bbclass still
# hard-depends on gptfdisk-native for do_image_tegraflash_tar. Drop this once
# meta-tegra switches away from sgdisk.
